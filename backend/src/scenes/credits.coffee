...
#Crafty.e('Credits');
  ...
  Crafty.e('2D, DOM, Text').text('Game-Framework is Crafty (<a target="_blank" href="http://craftyjs.com">http://craftyjs.com</a>)<br>' +
      ...
      'http://www.github.com/olilo/flower-tower-defense/</a>)').textFont(Game.creditsTextFont).
  textColor(Game.textColor).css(Game.centerCss).attr
    x: 0
    y: 70
    w: Game.width()
    h: 100
  ...
  Crafty.e('2D, DOM, Text').text('Title-Song and Won-Song generated by Music Maker Jam<br>' +
      'Game-Music by <a target="_blank" href="http://opengameart.org/users/tkz-productions">TKZ Productions</a>').
  textFont(Game.creditsTextFont).textColor(Game.textColor).css(Game.centerCss).attr
    x: 0
    y: 340
    w: Game.width()
