...
#Crafty.e('Credits');
  ...
  Crafty.e('2D, DOM, Text').text('Music:').textFont(Game.creditsFont).textColor(Game.highlightColor).css(Game.centerCss).attr
    ...
    w: Game.width()
    h: 50
  Crafty.e('2D, DOM, Text').text('Title-Song and Won-Song generated by Music Maker Jam<br>' + 'Game-Music by <a href="http://opengameart.org/users/tkz-productions">TKZ Productions</a>').textFont(Game.creditsTextFont).textColor(Game.textColor).css(Game.centerCss).attr
    x: 0
    y: 340
    w: Game.width()
    h: 100
