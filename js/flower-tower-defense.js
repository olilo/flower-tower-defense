...
(function() {
  Crafty.scene('Credits', function(targetScene) {
    ...
    // FIXME generate links outside
    Crafty.e('2D, DOM, Text').text('Title-Song and Won-Song generated by Music Maker Jam<br>' + 'Game-Music by <a target="_blank" href="https://opengameart.org/users/tkz-productions">WakianTech</a>').textFont(Game.creditsTextFont).textColor(Game.textColor).css(Game.centerCss).attr({
      x: 0,
      y: 340,
      w: Game.width(),
      h: 100
